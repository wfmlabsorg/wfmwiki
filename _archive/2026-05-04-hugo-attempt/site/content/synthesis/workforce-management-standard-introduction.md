...
![Traditional WFM balance](/img/mediawiki/Open_Source_Maturity_Curve_12192022_balance2.png)
...
![WFM Labs Maturity Model™](/img/mediawiki/WFMLabsMaturityModel.png)The approach described in the rest of this section aligns has been plotted on an updated {{< wikilink "synthesis/wfm-labs-maturity-model" >}} . We demonstrate the culmination of processes leveraged over the past three decades to be aligned with "Level 2 - Legacy WFM Practices. An organization having defined legacy WFM processes is far superior to Level 1 - manual processes which do not leverage WFM software. Yet, the updated maturity curve outlines 3 additional levels the Future WFM Operating Standard seeks in incorporate. The maturity curve levels are described in more detail {{< wikilink "synthesis/wfm-labs-maturity-model" "here." >}}
