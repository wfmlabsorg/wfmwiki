...
![Outcome plot of FTEs required](/img/mediawiki/Outcome_Plot_FTEs.jpg)
...
By expressing a range of outcomes, simulations can facilitate a change in how we introduce a new goal for the Future WFM model: [Risk Ratings.](/synthesis/wfm-goals/#risk-ratings)
...
![Occupancy_Max_Erlang_Excel2.jpg](/img/mediawiki/Occupancy_Max_Erlang_Excel2.jpg)
...
![Excel_max_occ_gif.gif](/img/mediawiki/Excel_max_occ_gif.gif)
...
![Occupancy Discount](/img/mediawiki/Occupancy_headroom.jpg)
...
![Calibrate-weekly.jpg](/img/mediawiki/Calibrate-weekly.jpg)
...
![Shift Bid Cycle](/img/mediawiki/Shift-Bid_Cycle.jpg)
...
When it becomes necessary to allocate resources to other channels, the operating standard again suggests automation to continuously monitor the primary channel (for example voice: calls in queue, or voice: agents available) to trigger automations to reallocate to a secondary channel when conditions are met. This is similar automations listed [Real-Time Automation](/synthesis/wfm-processes/#real-time-automation).
