...
## [2026-05-05 16:21] publish | Edited "Main Page" — Main Page restructure per Ted: (1) Featured Today moved to top as floated right-side box (360px), splitting the Welcome section into two-column visual. (2) Connected-sites bulleted list removed from Welcome — Kyōdō no longer listed there per Ted no further outreach to kyodo. Replaced with single prose line: extension of WFM Labs which includes community at community.wfmlabs.org. Kyōdō remains in the Connect section at page bottom for completeness. Featured Today thumbnails increased to 320px to fill the box. Bold (not heading) for Featured Today label and page titles inside the box for cleaner section-editing. (rev 652)

## [2026-05-05 15:50] ingest | Scheduling cluster batch 1: 4 new pages — Scheduling Methods overview (rev 648), Shift Design (rev 649), Schedule Generation (rev 650), Adherence and Conformance (rev 651). Plus CSC fix on Event Management (rev 532→647) — replaced Comcast-specific http://csc references with universal ticketing language. Source stack: Koole 2013 (primary, Call Center Optimization PDF at cs.vu.nl/~koole/ccmath/book.pdf), Pinedo 2022, Gans-Koole-Mandelbaum 2003, Aksin-Armony-Mehrotra 2007, Cleveland (ICMI), Reynolds (Call Center School). 3 forward-referenced links (Multi-Skill Scheduling, Self-Scheduling and Flexible Workforce Models, Real-Time Schedule Adjustment) intentionally show as red links — planned Batch 2 pages.

## [2026-05-05 15:49] publish | Edited "Adherence and Conformance" — Create concept page on the two distinct WFM compliance metrics. Adherence (when - moment-by-moment activity match) vs conformance (how much - total time in each activity), with equations. Calculation details (grace periods activity classifications measurement period). When adherence vs conformance matters more. Common WFM pitfalls (confusing the metrics, unrealistic targets, ignoring grace periods, treating as discipline tool, ignoring tradeoff with Variance Harvesting). Real-time adherence dashboards. Connection to ROC Daily Routine and Future WFM Operating Standard reorientation away from policing. Cited Koole, Cleveland, Reynolds. (rev 651)

## [2026-05-05 15:49] publish | Edited "Schedule Generation" — Create method page on schedule generation optimization. Set covering / set partitioning formulation with equations, solution methods (LP relaxation, branch-and-bound/branch-and-cut, column generation, heuristics — genetic, simulated annealing, constraint programming), common WFM constraints (hard and soft), multi-objective formulation, what WFM software does under the hood, common pitfalls (cost-only optimization, soft-as-hard, point-forecast fragility), performance considerations by problem scale. Cited Koole, Pinedo, Gans-Koole-Mandelbaum, Aksin-Armony-Mehrotra. (rev 650)

## [2026-05-05 15:49] publish | Edited "Shift Design" — Create method page on shift catalog design. Components of a shift, why shift design matters, designing a catalog, coverage curves and shift profiles with equation, common shift design parameters (start times durations break placement off-phone slots days of week), common WFM pitfalls (stale catalog too few/too many shifts break placement fighting coverage). Catalog refresh cadence. Connection to forecasting and probabilistic forecasting (designing against P50 vs P80). Cited Koole, Cleveland, Gans-Koole-Mandelbaum. (rev 649)

## [2026-05-05 15:49] publish | Edited "Scheduling Methods" — Create master overview for the scheduling cluster (parallel to Forecasting Methods). Decision tree for scheduling problem characteristics, family-at-a-glance table, the four scheduling decisions (what shifts / who works / how compliance / how change), inputs and outputs, common WFM scheduling objectives. Cited Koole 2013 (Call Center Optimization, primary), Pinedo, Gans-Koole-Mandelbaum 2003, Aksin-Armony-Mehrotra 2007, Cleveland (ICMI), Reynolds (Call Center School). Cross-links to existing WFM Processes, WFM Roles, ROC, Forecasting Methods, Variance Harvesting. (rev 648)

## [2026-05-05 15:42] publish | Edited "Event Management" — Replace CSC references with universal ticketing language. Per Ted: CSC was an old reference to a system at Comcast Command Center — vendor-specific detail that should not appear in practitioner reference content. Heading CSC Tickets → Severity 4 Tickets; http://csc prose artifacts → ticketing system. (rev 647)
