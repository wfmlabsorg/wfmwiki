...
Both simulation types integrate with the **{{< wikilink "synthesis/future-wfm-operating-standard" >}}** ecosystem:
...
- **{{< wikilink "synthesis/future-wfm-operating-standard" >}}** - Comprehensive framework integrating simulation approaches
